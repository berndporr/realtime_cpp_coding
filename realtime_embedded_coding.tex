...
Another popular approach is defining a method in an \textsl{interface
  class} as \textsl{abstract} and asking the client class to implement
...
\end{verbatim}
and then registering a pointer to it:
\begin{verbatim}
...
...
creating an abstract type in the publisher with the help of a
an abstract method which then needs to be implemented in the subscribing
class. This is a very efficient way and the pure C++ way. However,
