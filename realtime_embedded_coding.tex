...
ready or crash sensor has been triggered. The Linux kernel then receives
...
until a kernel-side interrupt has happened. These can then be translated
back into callbacks between classes by waking up threads. Data is transmitted 
...
\item all public interfaces have \textbf{doc-strings} for all public
  ...
  example with the help of doxygen.
\item classes which perform internal processing such as filters,
  databases, detectors, \ldots have \textbf{unit tests} and are started via
