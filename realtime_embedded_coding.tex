...
\begin{enumerate}
\item choose the I/O subsystem you want to use.
A subsystem is referred to as \textsl{chip} dating back to when
each group of GPIO pins had their own physical device. Selection can be
made either by number, name or pseudo-file:
\begin{verbatim}
