...
\begin{enumerate}
 \item Create the participant that will itneract with the topic;
...
The relevant code from the example which sets up the infrasrtucture reads
very similarly to the pubisher, except that of course the participant is used
